...
Полное описание пунктов меню 0–33: [docs/MENU.ru.md](docs/MENU.ru.md) · [docs/MENU.en.md](docs/MENU.en.md).

В `1.5.6` корень SUB больше не отвечает HTTP 500 на nginx 1.24 (`try_files` вместо `alias` на `/`).
