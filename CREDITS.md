...
В `1.6.0` личный кабинет пользователя (пункт **34**): вход email/Telegram/VK/Яндекс, тарифы, пробный период, ссылка подписки, инструкции устройств; админ правит меню. Тест без платёжных шлюзов: `remnawave-cabinet-test.sh`.
