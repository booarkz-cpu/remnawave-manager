...
# Установка Remnawave Manager 1.5.6

HTTP 500 на корне домена подписки (nginx 1.24, `alias` на `location = /`). Сначала `self-update`, затем пункт **33** → 4 или `sub-stub refresh`. Ссылки `/shortUuid` не ломаются.

jsDelivr: `@v1.5.6` / `e27712e9308fbcd8fca62dae9c2549c1cd994068bac6662f8e9a173387e80c23`.
