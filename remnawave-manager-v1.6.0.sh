...
sub_stub_nginx_locations(){
  ...
  location = / {
    ...
    alias /var/www/sub-site/index.html;
  }
  location = /index.html { alias /var/www/sub-site/index.html; }
  location = /about.html { alias /var/www/sub-site/about.html; }
  location = /breeds.html { alias /var/www/sub-site/breeds.html; }
  location = /gallery.html { alias /var/www/sub-site/gallery.html; }
  location = /contact.html { alias /var/www/sub-site/contact.html; }
  location = /styles.css { alias /var/www/sub-site/styles.css; }
  location = /robots.txt { alias /var/www/sub-site/robots.txt; }
  location = /favicon.svg { alias /var/www/sub-site/favicon.svg; }
  location ^~ /img/ {
    alias /var/www/sub-site/img/;
    expires 7d;
...
sub_stub_status(){
  ...
  if [[ ${SUB_STUB:-1} -eq 1 ]]; then
    ...
    [[ -f "${SUB_SITE:-/var/www/sub-site}/index.html" ]] && echo "  ${SUB_SITE:-/var/www/sub-site}"
    [[ -f "${SUB_SITE:-/var/www/sub-site}/img/hero.jpg" ]] && echo "$(t stub_photos_ok "${SUB_SITE}/img")"
  else
...
write_cabinet_env(){
  local dir="${CABINET_DIR:-/opt/remnawave/cabinet}" pass
